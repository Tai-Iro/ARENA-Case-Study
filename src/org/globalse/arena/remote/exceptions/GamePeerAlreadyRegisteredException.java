 ...
 */
package org.globalse.arena.remote.exceptions;

public class GamePeerAlreadyRegisteredException extends ArenaException {
	
	public GamePeerAlreadyRegisteredException(String message) {
		super(message);
	}
}
