...
:defaultArg
set ARENA_CMD_LINE_ARGS="%ARENA_HOME%\conf\matchfrontend.properties
...
:runES
"%_JAVACMD%" -classpath "%LOCALCLASSPATH%"  %ARENA_OPTS% org.globalse.arena.matchfrontend.MatchFrontEnd %ARENA_CMD_LINE_ARGS%
goto end
